...
def _main(args, output_file):
    ...
    models, _model_args = checkpoint_utils.load_model_ensemble(
        ...
        inference_params={
            "score_reference": getattr(args, "score_reference", False),
            "save_datastore_path": getattr(args, "save_datastore_path", ""),
            "target_layer": getattr(args, "target_layer", None),
            "bilingual_enabled": getattr(args, "bilingual_enabled", False),
            "load_datastore_from": getattr(args, "load_datastore_from", "")
        }
    )
    ...
    itr = task.get_batch_iterator(
        ...
        is_teacher_forcing=getattr(args, "score_reference", False)
    ...
    for sample in progress:
        ...
        if args.score_reference:
            file_counter += 1
            if args.bilingual_enabled:
                file_path = args.save_datastore_path + "/bili." + str(args.target_layer) + "/xxx.k.npy"
                new_file_path = args.save_datastore_path + "/bili." + str(args.target_layer) + "/" + str(file_counter) + ".k.npy"
                os.rename(file_path, new_file_path)
                file_path = args.save_datastore_path + "/bili." + str(args.target_layer) + "/xxx.v.npy"
                new_file_path = args.save_datastore_path + "/bili." + str(args.target_layer) + "/" + str(file_counter) + ".v.npy"
                os.rename(file_path, new_file_path)
                file_path = args.save_datastore_path + "/mono." + str(args.target_layer) + "/xxx.v.npy"
                new_file_path = args.save_datastore_path + "/mono." + str(args.target_layer) + "/" + str(file_counter) + ".v.npy"
                os.rename(file_path, new_file_path)
            else:
                file_path = args.save_datastore_path + "/mono." + str(args.target_layer) + "/xxx.k.npy"
                new_file_path = args.save_datastore_path + "/mono." + str(args.target_layer) + "/" + str(file_counter) + ".k.npy"
                os.rename(file_path, new_file_path)
