...
def get_parser(desc, default_task="translation"):
    ...
    parser.add_argument('--load-datastore-from', type=str, help='path of datastores')
...
def add_generation_args(parser):
    ...
    group.add_argument('--save-datastore-path', default=None, type=str,
                       help='if score-reference, use this param to indicate where to save tmp results')
    group.add_argument('--target-layer', default=None, type=int,
                       help='if score-reference, use this param to indicate which layer these data belong to')
    group.add_argument('--bilingual-enabled', action='store_true',
                       help='if enabled, we will generate bilingual datastore and monolingual values')
