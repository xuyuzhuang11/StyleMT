...
def load_model_ensemble(filenames, arg_overrides=None, task=None, strict=True, suffix='', inference_params=None):
    ...
    ensemble, args, _task = load_model_ensemble_and_task(
        filenames, arg_overrides, task, strict, suffix, inference_params
    )
    return ensemble, args


def load_model_ensemble_and_task(filenames, arg_overrides=None, task=None, strict=True, suffix='', inference_params=None):
    ...
    for filename in filenames:
        ...
        if inference_params is not None:
            infer_parameters = Namespace(
                score_reference=inference_params["score_reference"],
                save_datastore_path=inference_params["save_datastore_path"],
                target_layer=inference_params["target_layer"],
                bilingual_enabled=inference_params["bilingual_enabled"],
                # load_datastore_from=inference_params["load_datastore_from"]
            )
            args = Namespace(**vars(args), **vars(infer_parameters))
        # print(args)
